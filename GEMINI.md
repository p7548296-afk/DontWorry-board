...
- docs/DOMAIN-POST-CONSTITUTION.md : 게시글 도메인 원칙
- docs/DOMAIN-POST-STATUTE.md : 게시글 도메인 규칙
- docs/DOMAIN-COMMENT-CONSTITUTION.md : 댓글 도메인 원칙
- docs/DOMAIN-COMMENT-STATUTE.md : 댓글 도메인 규칙
...
- 프로젝트명: Dont Worry Board
- 설명: 닉네임 기반 고민 상담 게시판
- 기술 스택: Next.js, Supabase, ShadCN UI, Tailwind CSS, TypeScript
- 도메인: MEMBER, POST, COMMENT
